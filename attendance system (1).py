...
model = load_model(r"C:\Users\HP\OneDrive\Desktop\face recognition\face recognition\final_model.h5")

labels = ['dd','dharitree','khushi','swgatika']   # Add your trained names
